...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _module_module01_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/module01.js */ \"./src/module/module01.js\");\n\n\n\ndocument.querySelector('.refresh-btn').addEventListener('click', (event) => {\n  event.preventDefault();\n  (0,_module_module01_js__WEBPACK_IMPORTED_MODULE_1__.displayScores)(); // Corrected function name\n});\n\ndocument.getElementById('submit').addEventListener('click', (event) => {\n  event.preventDefault();\n  const playerName = document.getElementById('name').value;\n  const playerScores = document.getElementById('score').value;\n  (0,_module_module01_js__WEBPACK_IMPORTED_MODULE_1__.postPlayerInfo)(playerName, playerScores); // Corrected function name\n  (0,_module_module01_js__WEBPACK_IMPORTED_MODULE_1__.clearInputFields)(); // Corrected function name\n});\n\n(0,_module_module01_js__WEBPACK_IMPORTED_MODULE_1__.createGame)(); // Corrected function name\n\n\n//# sourceURL=webpack://Leaderboard/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   clearInputFields: () => (/* binding */ clearInputFields),\n/* harmony export */   createGame: () => (/* binding */ createGame),\n/* harmony export */   displayScores: () => (/* binding */ displayScores),\n/* harmony export */   postPlayerInfo: () => (/* binding */ postPlayerInfo)\n/* harmony export */ });\n// Function to create a new game\nasync function createGame() {\n  const gameCreationUrl = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games';\n  \n  try {\n    const response = await fetch(gameCreationUrl, {\n      method: 'POST',\n      body: JSON.stringify({\n        name: 'Monopoly',\n      }),\n      headers: {\n        'Content-Type': 'application/json; charset=UTF-8',\n      },\n    });\n\n    // Handle any response if needed\n    // const data = await response.json();\n    // console.log(data);\n  } catch (error) {\n    console.error('Error creating a new game:', error);\n  }\n}\n\n// Function to post a player's scores\nasync function postPlayerInfo(playerName, playerScores) {\n  const gameId = 'rGp2reoqk4GMj6QaC1QY';\n  const scorePostUrl = `https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${gameId}/scores/`;\n\n  try {\n    const response = await fetch(scorePostUrl, {\n      method: 'POST',\n      body: JSON.stringify({\n        user: playerName,\n        score: playerScores,\n      }),\n      headers: {\n        'Content-Type': 'application/json; charset=UTF-8',\n      },\n    });\n\n    // Handle any response if needed\n    // const data = await response.json();\n    // console.log(data);\n  } catch (error) {\n    console.error('Error posting player scores:', error);\n  }\n}\n\n// Function to load and display scores\nasync function displayScores() {\n  const gameId = 'rGp2reoqk4GMj6QaC1QY';\n  const scoreLoadUrl = `https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${gameId}/scores/`;\n\n  try {\n    const response = await fetch(scoreLoadUrl);\n    const data = await response.json();\n    \n    // Sort scores by score value\n    data.result.sort((a, b) => b.score - a.score);\n\n    const scoreListElement = document.querySelector('#scoresList');\n    scoreListElement.innerHTML = '';\n\n    // Display scores in the HTML\n    data.result.forEach((e) => {\n      const li = document.createElement('li');\n      li.innerHTML = `<span>${e.user} : </span><span>${e.score}</span>`;\n      scoreListElement.appendChild(li);\n    });\n  } catch (error) {\n    console.error('Error loading scores:', error);\n  }\n}\n\n// Function to clear input fields\nfunction clearInputFields() {\n  const inputFields = document.querySelectorAll('input');\n  inputFields.forEach((input) => {\n    input.value = '';\n  });\n}\n\n// Export the functions\n\n\n\n//# sourceURL=webpack://Leaderboard/./src/module/module01.js?");
