...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _module_module_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/module.js */ \"./src/module/module.js\");\n\r\n\r\n\r\nconst scoresList = document.getElementById('scoresList');\r\nconst nameInput = document.getElementById('name');\r\nconst scoreInput = document.getElementById('score');\r\nconst submitButton = document.getElementById('submit');\r\nconst refreshButton = document.querySelector('.refresh-btn');\r\nfunction updateScoresList() {\r\n  const scores = (0,_module_module_js__WEBPACK_IMPORTED_MODULE_1__.getScores)();\r\n  scoresList.innerHTML = '';\r\n\r\n  scores.forEach((scoreObj) => {\r\n    const li = document.createElement('li');\r\n    li.textContent = `${scoreObj.name}: ${scoreObj.score}`;\r\n    scoresList.appendChild(li);\r\n  });\r\n}\r\n\r\nsubmitButton.addEventListener('click', () => {\r\n  const name = nameInput.value;\r\n  const score = parseInt(scoreInput.value, 10);\r\n\r\n  if (name && score) {\r\n    (0,_module_module_js__WEBPACK_IMPORTED_MODULE_1__.addScore)(name, score);\r\n    nameInput.value = '';\r\n    scoreInput.value = '';\r\n    updateScoresList();\r\n  }\r\n});\r\n\r\nrefreshButton.addEventListener('click', updateScoresList);\r\n\r\nupdateScoresList();\r\n\n\n//# sourceURL=webpack://Leaderboard/./src/index.js?");
